...
public class UpstreamSearchAction implements IObjectActionDelegate 
{
	private IStructuredSelection selection;
	private Shell shell;

	public UpstreamSearchAction() 
	{
		super();
	}
	...
	public void run(IAction action) 
	{
		...
		{					
			...
			while (elements.hasNext())
			{
				...
				{
					CreateSearch createSearch = CreateSearch.upstreamSearch((IMethod) element);

...
public class Display extends JComponent {
        ...
        MouseWheelListener, MouseListener, KeyListener
    {
        ...
        public void mouseMoved(MouseEvent e) {
            synchronized ( m_vis ) {
            	if (checkItemChanged(e))
            		return;

            	if ( activeItem != null ) {
                    fireItemMoved(activeItem, e);
                }
            	else 
            	{
                    fireMouseMoved(e);
        ...
        // Checks if an item has been entered or exited.
        private boolean checkItemChanged(MouseEvent e)
        {
        ...
        public void mouseClicked(MouseEvent e) {
            synchronized ( m_vis ) {
            	// BUG FIX: check first if there is an item selected. Normally, this happens on a mouse
            	// move. But, if there was a click that created a new item which is now under the mouse,
            	// it will not yet be selected if there has not yet been a move. Check here if there
            	// is actually an item selected
            	checkItemChanged(e);
